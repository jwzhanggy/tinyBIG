...
from tinybig.data.feynman_dataloader import feynman, dimensionless_feynman
from tinybig.data.function_dataloader import elementary_function, composite_function
from tinybig.data.classic_dataloader import classic_dataloader, diabetes, iris, banknote, wheat
